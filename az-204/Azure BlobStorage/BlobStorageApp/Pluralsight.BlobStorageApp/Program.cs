...
namespace Pluralsight.BlobStorageApp
{
  class Program
  {
    ...
    private static readonly string _connectionString = "DefaultEndpointsProtocol=https;AccountName=rando999;AccountKey=8taNLD80xvzc6BSZnCLLgSVL6eZY1Ne05w+7S3i40Wyl13GU8GIk4a6qAB+Pp2SCs9Lg/OozOEVbwo4d5/heDA==;EndpointSuffix=core.windows.net";
